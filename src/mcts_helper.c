 ...
 */
static int untried_list_create(MCTSBackground *bg, const void *actions, int num_actions, UntriedAction **head)
{
    if (num_actions == 0)
    {
        *head = NULL;
 ...
 */
static void node_pop_random_untried(MCTSNode *node, void *action_out, MCTSBackground *bg)
{
    /* 从未尝试动作链表中弹出头部*/
